package com.yoyohr.boot.framework.utils;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.JavaType;
import com.yoyohr.boot.framework.holder.ObjectMapperHolder;
...
public class JsonUtils {
    ...
    public static <T> T read(String json, JavaType javaType) {
        try {
            return ObjectMapperHolder.getInstance().readValue(json, javaType);
        } catch (JsonProcessingException e) {
            log.error(e.getMessage());
            return null;
        }
